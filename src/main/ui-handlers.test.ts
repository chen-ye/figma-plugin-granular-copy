...
describe('UI Handlers', () => {
  ...
  it('should handle SAVE_UI_SIZE', async () => {
    const msg: PluginMessage = { type: 'SAVE_UI_SIZE', width: 400, height: 500 };
    await handleUIMessage(msg);
    
    expect(figma.clientStorage.setAsync).toHaveBeenCalledWith('plugin_window_size', { width: 400, height: 500 });
  });
});